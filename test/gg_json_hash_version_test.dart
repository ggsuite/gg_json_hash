...
void main() {
  group('gg_json_hash_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_json_hash_version.dart');
